      ...
      return (
          <div className="p-8 max-w-4xl mx-auto animate-fade-in">
              ...
              {topic.quiz.map((q, qIndex) => {
                  ...
                  return (
                      <div key={qIndex} className={`mb-8 p-6 rounded-xl border transition-all duration-300 ${
                          showResult 
        ...
        {topic.sections.map((section, idx) => (
          <section key={idx} className="group relative">
            ...
            <div className="ml-12 prose prose-invert prose-slate max-w-none text-slate-300 leading-7 text-lg">
              <p dangerouslySetInnerHTML={{ __html: section.content.replace(/\*\*(.*?)\*\*/g, '<strong class="text-white font-bold bg-white/5 px-1 rounded">$1</strong>') }} />
            </div>
